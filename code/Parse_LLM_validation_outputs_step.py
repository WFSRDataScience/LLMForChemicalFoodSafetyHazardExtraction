...
Parse responses from LLM to step by step prompt for leafy greens and shellfish 
...
leafy_grped_by.reset_index().to_csv('../results/validation_leafy_llm_step_with_eval.csv', 
                                    index = False)
shellfish_grped_by.reset_index().to_csv('../results/validation_shellfish_llm_step_with_eval.csv', 
                                        index = False)